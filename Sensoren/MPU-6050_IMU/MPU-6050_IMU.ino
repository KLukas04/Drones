...
void setup() {
  ...
  digitalWrite(13, HIGH);                                              //Set digital output 13 high to indicate startup                                                //Set the LCD cursor to position to position 0,0
...
void write_LCD(){                                                      //Subroutine for writing the LCD
  ...
  if(lcd_loop_counter == 2){
    if(angle_pitch_buffer < 0)Serial.println("-");                          //Print - if value is negative
