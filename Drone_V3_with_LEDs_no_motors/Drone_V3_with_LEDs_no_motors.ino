...
void loop() {
  ...
  */
  ...
  analogWrite(4, map(pwmFrontLeft, 1000, 2000, 0, 255));
  analogWrite(4, map(pwmFrontRight, 1000, 2000, 0, 255));
  analogWrite(4, map(pwmBackLeft, 1000, 2000, 0, 255));
  analogWrite(4, map(pwmBackRight, 1000, 2000, 0, 255));
  /*
